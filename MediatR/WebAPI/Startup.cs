namespace WebAPI
{
    ...
    using MediatorHandler.NotificationHandler;
    using MediatR;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Inject and add MediatR to following assemblies: WebApi + MediatorReceiver + Core
            services.AddMediatR(
                typeof(Startup).GetTypeInfo().Assembly,
                typeof(GenericHandler).Assembly,   
                typeof(SomeNotification).Assembly);

            // PipelineBehavior has to be injected explicitly
